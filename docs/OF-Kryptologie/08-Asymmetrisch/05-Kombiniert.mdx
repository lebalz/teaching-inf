...
![Symmetrische und asymmetrische Verschlüsselung kombiniert --width=600px](img/symm-asymm-encryption.svg)
...
![--width=500px](img/symm-asymm-encryption-binary.svg)
...
![](img/entschluesselung-kombiniert.png)
</Solution>
:::
