...
page_id: b581371e-9d93-41d4-b12d-8f2f3c2e5221
---
...
![Symmetrische und asymmetrische Verschlüsselung kombiniert --width=600px](./images/symm-asymm-encryption.svg)
...
![--width=500px](./images/symm-asymm-encryption-binary.svg)

:::info[Auch symmetrische Verfahren sind sicher!]
...
![](./images/entschluesselung-kombiniert.png)
</Solution>
:::
