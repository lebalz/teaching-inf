...
<String id="d928f897-07c5-46a0-ab43-cc9e9f22f062" fullWidth solution="10001 10111 01010" monospace/>
::::
...
<String id="9b1e97dc-6807-4ec3-bc18-182a57b0a2d4" sanitizer={(val) => val.trim().toUpperCase()} fullWidth solution="GEIST" />
:::::
