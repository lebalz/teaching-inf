...
Während das _One-Time-Pad_ ein (theoretisch) perfektes Verschlüsselungsverfahren ist, bezeichnet ein _One-Time-Passwort_ (OTP) ein Passwort, das nur für eine einzige Anmeldung gültig ist. Es wird häufig bei der Zwei-Faktor-Authentifizierung verwendet.
:::
