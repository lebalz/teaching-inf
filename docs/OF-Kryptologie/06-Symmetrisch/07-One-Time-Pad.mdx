...
::br
  <DefinitionList>
    ...
    <dt></dt>
    <dt>Klartext</dt>
    <dd>→ __-3 + 26 = 23 = X__</dd>
  </DefinitionList>
:::


:::warning[One-Time-Pad ≠ One-Time-Passwort]
Wàhrend das _One-Time-Pad_ ein (theoretisch) perfektes Verschlüsselungsverfahren ist, bezeichnet ein _One-Time-Passwort_ (OTP) ein Passwort, das nur für eine einzige Anmeldung gültig ist. Es wird häufig bei der Zwei-Faktor-Authentifizierung verwendet.
:::
...
- **Einmalverwendung des Schlüssels:** Wir dürfen jeden Schlüssel nur einmal verwenden. Wenn wir es schaffen, diesen Schlüssel jeweils sicher zu übermitteln, dann könnten wir vermutlich oft auch mit selbiger Methode einfach gleich die geheime Nachricht sicher übermitteln.
</Solution>
:::
...
AES (Advanced Encryption Standard) ist eine heute weit verbreitete Blockchiffre, die in vielen Anwendungen eingesetzt wird, z.B. bei der Verschlüsselung von WLAN-Passwörtern (WPA2). AES ist zwar nicht perfekt sicher wie das One-Time-Pad, aber dennoch sehr sicher und zudem viel praktischer im Einsatz.

[AES erklärt](https://www.heise.de/hintergrund/Cryptography-Engineering-Teil-1-Zur-Theorie-des-Advanced-Encryption-Standard-1350362.html)


### ⭐ DES (optional)
DES (Data Encryption Standard) war der Vorgänger von AES und wurde in den 1970er Jahren entwickelt. Aufgrund seiner kurzen Schlüssellänge von 56 Bit gilt DES heute als unsicher und wird nicht mehr verwendet. Dennoch ist es ein interessantes Beispiel für die Entwicklung der Kryptographie.

[DES erklärt](https://www.matheprisma.de/Module/DES)
