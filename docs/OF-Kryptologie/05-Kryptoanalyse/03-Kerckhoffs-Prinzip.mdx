...
<div style={{width: "100%", display: "flex", justifyContent: "center", marginBottom: "1rem"}}>  
  <iframe
    ...
    width="320"
    height="480"
    src="https://www.learningsnacks.de/share/533572/" />
</div>

Geben Sie das Lösungswort hier ein und überprüfen Sie Ihre Antwort:
<String id="1d209204-9954-4355-b81d-39009ba97bdc" label="Lösungswort" solution="xJ73HeJPl$F!" sanitizer={(v) => (v || '').trim()} />
:::

<Answer type="text" id="afe3a4e9-6a00-450c-a2b5-bcbc21894d39" placeholder="✍️ Notizen..." />
