...
![Jede Person besitzt ein Schlüsselpaar --width=500px](./images/key-pair.svg)
...
![Asymmetrische Verschlüsselung --width=500px](./images/asymm-encryption.svg)
...
Wir müssen das Dokument für jede Person einzeln verschlüsseln, da jede Empfänger:in ein eigenes Schlüsselpaar verwendet. Das erhöht den Rechenaufwand, zumal die asymmetrische Verschlüsselung ohnehin bereits deutlich rechenintensiver ist, als die symmetrische.
</Solution>
:::
