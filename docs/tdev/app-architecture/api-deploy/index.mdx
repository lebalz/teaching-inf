...
import { generateRandomBase64 } from './seecureToken';
...
<Steps>
  1. Eine neue App __<Val name="app" />__ auf dem Server erstellen
      ...
      <DynamicInput name="SESSION_SECRET" monospace default={generateRandomBase64()} onRecalculate={() => generateRandomBase64()} />
