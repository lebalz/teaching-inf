...
---
import Excalidoc from '@tdev-components/documents/Excalidoc';
import Restricted from '@tdev-components/documents/Restricted';
import HuffmanTreeVisualizer from '@tdev-components/VisualizationTools/HuffmanTree';
...
3. Codieren Sie das Wort.
    ...
    <Answer type="string" id="4d0938a3-9498-43e7-a200-2674630c5984" fullWidth solution="100 11 0 0 11 0 0 11 101 101 11" sanitizer={(val) => val.replaceAll(/[^\d]/g, '')}/>
...
3. Codieren Sie das Wort.
    ...
    <Answer type="string" id="7b60a307-3b32-4789-92d3-56152a41a1dc" fullWidth solution="11 1001 010 11 011 000 11 011 1000 11 101 101 11 001 010" sanitizer={(val) => val.replaceAll(/[^\d]/g, '')}/>
