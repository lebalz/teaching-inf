...
:::aufgabe[Mein Name]
<Answer type="state" id="ef5b1209-18d3-477a-9734-2bec4f45c6fe" />

Halten Sie Ihren Namen codiert als QR-Code, Braillezeichen oder in weiteren Codes fest.

<Answer type="text" id="d7aa78aa-3ba1-4548-9a6d-b9f6bfe1b446" />
:::
...
export const QrCodeComponent = () => {
    ...
    return (
        <QrCode withInput size="30em" text={user?.name || 'Hallo Welt'} download />
    )
