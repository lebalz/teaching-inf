...
Da für jedes Kästchen zwei Möglichkeiten vorhanden sind, können wir ein Byte auf $2^8=256$ verschiedene Arten mit Nullen und Einsen füllen. Mit einem Byte können also $256$ verschiedene Dinge gespeichert werden, beispielsweise die Zahlen $0$ bis $255$ oder total $256$ verschiedene Schriftzeichen.

## SI-Präfixe

SI
: **Internationales Einheitensystem** (französisch für *Système international d'unités*)
: international anerkanntes System von Einheiten, das die Grundlage für die meisten Masseinheiten bildet.
: **Beispiele**
:::dd
...
FÜr die Angabe von Datenmengen werden die SI-Präfixe verwendet, welche die Datenmenge mit einer Zehnerpotenz multiplizieren:
...
<div className="small-table center">
  ...
  | Terabyte    | Speicherplatz einer (eher kleinen) Festplatte (2026) |  `1 TB` | $10^{12}$ | `1000 GB` |
...
Weil Datenspeicher eine binäre Adressierung verwenden, sind Speicherkapazitäten üblicherweise Zweierpotenzen. Deshalb war es früher üblich, $2^{10}=1024$ Byte als ein Kilobyte oder `1 kB` zu bezeichnen.

1996 hat die International Electrotechnical Commission (IEC) spezielle Einheitsgrössen für **Binärpräfixe** festgelegt:

<div className="small-table center">
  | Bezeichnungen |  Kürzel |   Potenz |    Grösse |
  | :------------ | ------: | -------: | --------: |
  | Kibibyte      | `1 kiB` | $2^{10}$ | `1024 B` |
...
- <String label="128 MiB = " unit="MB" solution="134" type="number" sanitizer={(val) => val.split('.')[0]} inline inputWidth="8em" id="300e802b-8182-4670-902e-179bf52b144a" />
- <String label="128 MB = " unit="MiB" solution="122" type="number" sanitizer={(val) => val.split('.')[0]} inline inputWidth="8em" id="7bacaad3-2bd6-4a68-9b08-581da0f08e0d" />
...
1. Wie viele Lochkarten sind nötig, um den gesamten Speicherplatz des iPhones als Hollerith-Lochkarten abzuspeichern?
   <String label="Anzahl Lochkarten" solution="3200000000" type="number" id="baf72a29-9548-4217-99f0-c58728d0c8df" />
2. Wenn nun alle Lochkarten auf denselben Stapel gelegt werden: wie hoch wird dieser Turm?
   <String label="Höhe des Turms" solution="544" type="number" unit="km" id="80567cb1-52ea-4a75-9283-a2802e76e76e" />
3. Vom Gymnasium Biel-Seeland zum Bundeshaus in Bern ist die Luftlinie $26$ km lang. Wie oft kann diese Strecke mit dem Lochkarten-Turm überbrückt werden? (Ergebnis auf ganze Zahlen runden)
   <String solution="21" unit="mal nach Bern" type="number" id="4755fd92-c343-4bca-a20b-811797dfaf80" />

<Solution id="c95f0357-79b8-4c1c-96fe-5aee143b2ee4">
  1) $256 GB$ zu Anzahl Lochkarten:
     - $256 GB = 256 \cdot 10^9 B$
     - $1$ Lochkarte hat $80$ Bytes
     - $\frac{256 \cdot 10^9 B}{80 B} = 3'200'000'000$ Lochkarten
  2) Höhe des Turms:
     - $1$ Lochkarte hat eine Höhe von $0.17$ mm
     - $3'200'000'000$ Lochkarten haben eine Höhe von $3'200'000'000 \cdot 0.17 mm = 544 km$
  3) Strecke vom Gymnasium Biel-Seeland zum Bundeshaus in Bern:
     - $1$ Strecke = $26$ km
     - $\frac{544 km}{26 km} \approx 20.92$ mal
     - $\rightarrow$ also ca. $21$ mal. Die Stapel nebeneinander gelegt würde also einen fast $4$ m breite Strasse ergeben ($18.7 cm \cdot 21$).
</Solution>
::::
