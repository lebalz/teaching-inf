...
2. Das Textdokument weist neben dem Textinhalt auch eine bestimmte Darstellung auf. Diese Darstellung muss ebenfalls in der Binär-Form gespeichert werden, um sie später wiederherstellen zu können! Wie könnten Sie diese Darstellungsinformationen möglichst präzise und eindeutig erfassen? Fügen Sie diese Zusatzinformationen zur Darstellung hinzu:
    <QuillV2 hideToolbar monospace id="e0c8e9e0-cec6-4fc4-b2ee-ee068339b275" />
3. Übersetzen Sie den Text in die Binär-Form mit dem obigen Tool.
    <QuillV2 hideToolbar monospace id="90df530d-aeac-47a2-9841-350d764bc646" />
...
5. Transformieren Sie den erhaltenen Binär-Code zurück in ein menschenlesbares Textdokument und halten Sie den Inhalt fest.
    <QuillV2 hideToolbar monospace id="0cf89aa9-c120-4040-8d6c-6c6c56ef1f30" />
...
7. Tauschen Sie sich aus: was hat gut funktioniert, was war schwierig? Wie würden Sie Ihre Formatierungs-Hinweise anpassen, damit sie eindeutiger/besser funktionieren?
    <QuillV2 id="d44dfb55-1f8e-4322-9080-fae5c949fd07" />
8. Gedankenexperiment: Sie würden bei Ihrem digitalen Dokument gerne untenstehendes Katzenbildli einfügen. Wie würden Sie dies bei Ihrem Format spezifizieren?
    <RandomCatImage />
    <QuillV2 id="d44dfb55-1f8e-4322-9080-fae5c949fd07" />
