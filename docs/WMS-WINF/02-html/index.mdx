...
: z.B. bei `<p>` ist der Tagname `p`, für englisch **P**aragraph.
öffnende Tags
...
:::info[Weshalb nicht direkt mit AI?]
...
<ProgressState confirm labels={['Überschriften', 'Paragraphen', 'Ungeordnete Listen', 'Geordnete Listen', 'Formatierungen']} id="be56d813-c25b-48ca-ae33-f4188deb40cb">
