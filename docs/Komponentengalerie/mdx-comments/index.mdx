...
Damit die Kommentarfunktion gebraucht werden kann, braucht es das Plugin [👉 remark-page](../remark-page).
:::
...
:::info[`src/stores/DocumentStore.ts`]
```tsx {4-5}
