...
<BrowserWindow>
    <WithCmsText entries={{demo: "30918f4b-8400-42d9-8e1f-f19d27357494", code: "f6b64809-e570-4a88-9a84-6c57e0240e38"}} showActions>
        <DefinitionList>
            <dt>Hallo</dt>
            <dd>Das ist der erste Eintrag.</dd>
            <dt>Welt</dt>
            <dd>Das ist der zweite Eintrag.</dd>
            <dt>CMS-Eintrag</dt>
            <dd><CmsText name="demo" showActions /></dd>
            <dt>CMS-Code</dt>
