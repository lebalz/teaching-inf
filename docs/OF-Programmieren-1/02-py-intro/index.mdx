...
Befehlsname
       ...
       \___/ \                   \_____/
         /   kein Parameter         |
Befehlsname                  Befehlsaufruf (inkl. Klammern)
```
...
:::warning[`'string'`]
Beachten Sie die Anführungszeichen rund um die Farb-Namen. Damit Python die Farben als Text (eng. `string`) erkennt und nicht plötzlich nach einem gleichnamigen Befehl sucht, werden rund **um Texte immer Anführungszeichen** verwendet. Es spielt dabei keine Rolle, ob Sie einfache `'` oder doppelte `"` Anführungszeichen verwenden.
:::
...
Ändern Sie das Programm so ab, dass die gewürfelte Zahl `5` gezeichnet wird (*ohne Umrandung, nur die Punkte*).
...
:::aufgabe[Erweiterung Aufgabe 3: Zickzack]
<Answer type="state" id="b8c7b225-0558-4379-831a-46481b15401a" />
Erweitern Sie das Programm 3 __ZICKZACK.PY__ so, dass Sie bei jedem Richtungswechsel ein Punkt gezeichnet wird:

![](images/zickzack_py_dots.svg)
<Solution id="0e2faf03-65a0-4dc5-85c9-425f13b6a3c4">
...
::::aufgabe[⭐ Haus von Nikolaus]
<Answer type="state" id="98de0fb1-5032-43a2-b2b3-5d612f0aa49f" />
...
```py live_py title=haus__nikolaus.py id=49701941-1296-4805-a489-f50154a5ba9e
from turtle import *
```

:::details[Hinweis: Diagonale]
...
<Solution id="dfe3919f-e285-4764-817d-9baf177e81b1">
