---
page_id: 53a34d81-4417-4351-b6f9-0b99ecabb5ff
---
...
In der [Aufgabe 7](../02-py-intro/index.mdx#aufgaben) haben Sie eine Treppe gezeichnet. Ihr Programm sieht vermutlich etwa wie folgt aus:
...
Ein Algorithmus kann Sequenzen wiederholt ausführen. In Python wird die zu wiederholende Sequenz **Codeblock** genannt. Ein Codeblock ist immer eingerückt (im Vergleich zur vorhergehenden Zeile) und wird mit einem Doppelpunkt `:` eingeleitet.
...
`i` ist ein Schleifenzähler, der bei jeder Wiederholung um `1` erhöht wird. Für die Übungen auf dieser Seite brauchen wir ihn aber noch nicht.
...
::::aufgabe[4. Treppe vol. 2]
<Answer type="state" id="1f478252-8656-47d2-9905-8dfa9f621af6" />
...
:::details[Hinweis]
Verwenden Sie den Befehl [`goto(x, y)`](../20-commands/index.mdx#gotox-y) um die Turtle bei `-200, -200` zu positionieren.
:::

<Solution id="fdd8f748-8727-4901-884c-b36b424c7c3b">
...
:::aufgabe[5. Schneestern]
<Answer type="state" id="739d205c-59af-4d11-ad53-7c32f0f39dee" />
...
```
<Solution id="41011ea5-b07a-4e95-88c6-c4844bdc9fc2">
...
:::aufgabe[6. Weihnachtsstern]
<Answer type="state" id="32d650c6-4422-41c8-bb3b-c40a6e42c8b4" />

1. Zeichnen Sie einen Weihnachtsstern mit den Drehwinkeln `140°` und `80°`.
2. Füllen Sie den Stern mit Ihrer Lieblingsfarbe. Studieren Sie dazu zuerst die drei Befehle im Kapitel "Füllen" unter [Turtle Befehle](../20-commands/index.mdx#füllen).
...
```
<Solution id="81d5ca4e-0b04-434a-a8c0-b84a1452da76">
...
<Answer type="state" id="64055a7b-64ff-4bf9-aaf5-f82acc56cbad" />
...
:::aufgabe[8. Quadrate]
<Answer type="state" id="13b8185f-9ffa-4553-8e10-8129ad8240f9" />
...
:::aufgabe[9. Vogel]
<Answer type="state" id="15dbe59c-3d22-44d4-ae01-7dd63e2964ec" />
...
::::aufgabe[⭐ 10. Stern]
<Answer type="state" id="73dc711c-a739-4abe-a937-3f4943ea43e8" />

Erstellen Sie folgenden Stern. Überlegen Sie sich, wie er aufgebaut ist und wie Sie ihn mit möglichst wenig Code zeichnen können.

![](./images/quadrat-stern.svg)

```py live_py title=stern.py id=de0335a9-6279-40b9-a6db-a012e1179f75
from turtle import *

```

:::details[Hinweis]
Der Stern besteht aus 20 Quadraten

![](./images/quadrat-stern-erklaert.svg)
:::

<Solution id="72e99fda-c250-4381-b461-ed359b7d0be4">
