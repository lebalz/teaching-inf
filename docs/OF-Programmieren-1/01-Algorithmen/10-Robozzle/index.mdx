    ...
    <div style={{ marginBottom: '1em' }}>
      {fns.map((fn, i) => (
        <div key={i} style={{ display: 'flex', alignItems: 'center' }}>
          <h3 style={{ width: '4em', marginBottom: 0, alignSelf: 'flex-start', paddingTop: '0.4em' }}>{fn.name}:</h3>
...
:::aufgabe[Robozzle 3]
  ...
  [Puzzle 3](https://alexanderson1993.github.io/robozzle-react/?level=-3)

  ![Puzzle 3 --width=350px](./images/robozzle-3.png)
  <Solution 
    fns={[
      { name: 'Mn', fields: 2}
    ]}
...
:::aufgabe[Robozzle 4]
  ...
  [Puzzle 4](https://alexanderson1993.github.io/robozzle-react/?level=14261)

  ![Puzzle 4 --width=350px](./images/robozzle-14261.png)
