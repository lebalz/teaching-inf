...
::video[./assets/microbit-ex-top-down.mp4]{autoplay=true loop=true height="220px" width="100%"}
...
::video[./assets/microbit-ex-left-right.mp4]{autoplay=true loop=true height="220px" width="100%"}
...
::video[./assets/microbit-ex-fill-and-clear.mp4]{autoplay=true loop=true height="220px" width="100%"}
...
::video[./assets/microbit-ex-random.mp4]{autoplay=true loop=true height="220px" width="100%"}
...
::video[./assets/microbit-ex-diag.mp4]{autoplay=true loop=true height="220px" width="100%"}
