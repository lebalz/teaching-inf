...
Ändern Sie das Ratespiel aus dem Kapitel [Verzweigungen](../04-Verzweigungen/index.mdx#ratespiel) so ab, dass die Spieler:in unendlich viele Versuche hat um die Zahl zu finden.
