...
```py live_py id=97f21544-4213-4fb4-8168-e1fb6d18a62e
...
:::aufgabe[Micro:Bit - Display Füllen]
<Answer type="state" id="321f1e85-b677-4e20-9980-49d06768f4f1" />

CodeEditor
: https://python.microbit.org/v/3/project

::video[./assets/microbit-ex-1.mp4]{autoplay=true loop=true}

```py live_py id=d37c8ada-93f7-4e7c-b7ef-6ae6089837f1
...
:::aufgabe[Micro:Bit - Display Füllen 2]
<Answer type="state" id="a83c240d-02af-4fc3-92cf-f0fcc6e460ca" />

CodeEditor
: https://python.microbit.org/v/3/project

::video[./assets/microbit-ex-2.mp4]{autoplay=true loop=true}

```py live_py id=698d29e7-02a7-4022-b6a0-4629010d8119
