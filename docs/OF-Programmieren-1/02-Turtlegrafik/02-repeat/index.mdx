...
In der [Aufgabe 7](./intro#aufgaben) haben Sie eine Treppe gezeichnet. Ihr Programm sieht vermutlich etwa wie folgt aus:
...
:::details[Hinweis]
Verwenden Sie den Befehl [`goto(x, y)`](./commands#gotox-y) um die Turtle bei `-200, -200` zu positionieren.
:::
...
2. Füllen Sie den Stern mit Ihrer Lieblingsfarbe. Schauen Sie sich dazu den Abschnitt "Füllen" unter [👉 Turtle Befehle](./commands#füllen) an.
