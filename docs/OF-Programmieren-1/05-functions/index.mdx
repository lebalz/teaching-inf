...
<ProgressState id="f39b43cf-6052-4adc-a55f-b8440277b3e6">
1. Zeichnen Sie ein Sechseck (noch ohne Unterprogramme!):
    ![](./images/sechseck.svg)
...
::::aufgabe[Aufgabe 4 – Blume]
<Answer type="state" id="5f71b333-fd7d-446e-998b-d65c69bec060" />

Sie werden in dieser Aufgabe[^1] unter der Verwendung mehrerer Unterprogramme eine komplexe Aufgabe schrittweise lösen.
...
[^1]: Diese Aufgabe ist inspiriert von [rothe.io](https://rothe.io/?b=prog1&p=416425).