...
Standardmässig wird die generierte Seite über kostenlose CDNs gehosted (Github Pages, Netlify, CLoudflare...). Der Nachteil ist, dass die Inhalte frei zugänglich sind und somit nur lizensierte oder freie Inhalte publiziert werden dürfen. Dies erfordert viel Aufwand und ist im Schulkontext nicht immer möglich.
...
1. Eine neue App auf dem Server erstellen
    ...
    ```
    Vor der ersten Veröffentlichung sollte die Umgebungsvariablen wie folgt gesetzt sein
