...
<Steps>
  1. Eine neue App __<Dyn name="app" />__ auf dem Server erstellen
      <DynamicInput name="app" defaultValue='info-teaching-website' />
      <DynamicInput name="domain" defaultValue='info.gbsl.website' />
      <DynamicInput name="API_URI" defaultValue='api://xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx' />
      <DynamicInput name="BACKEND_URL" defaultValue='https://xxx-api.gbsl.website' />
      <DynamicInput name="CLIENT_ID" defaultValue='xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx' />
      <DynamicInput name="TENANT_ID" defaultValue='xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx' />
      <br />
      <TemplateCode>
      ...
      :::details[Alternativ: direkt über <Dyn as="code">`/home/dokku/{{app}}/ENV`</Dyn>]
      <TemplateCode>
