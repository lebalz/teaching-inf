...
page_id: 8f179342-b762-4504-af99-3f32b6125f01
---
...
<Answer type="state" id="627b8aae-b77f-4e6e-8951-00c0b397f3b9" />

Führen Sie eine schriftliche Addition für die folgenden binären Zahlen durch:

- $1001_2 + 110_2$
  <Answer type="string" id="c862b993-8074-46fa-bf4f-6856b29ebcdf" solution="1111" sanitizer={(val) => val.replaceAll(/[^\d]/g, '')}/>
- $111_2 + 1_2$
  <Answer type="string" id="61ea2f9c-86d8-4a36-a882-2ff3416def8b" solution="1000" sanitizer={(val) => val.replaceAll(/[^\d]/g, '')}/>
- $101_2 + 101_2$
  <Answer type="string" id="b2e85cad-8403-42b6-aaee-e390cebb2a13" solution="1010" sanitizer={(val) => val.replaceAll(/[^\d]/g, '')}/>
...
<Answer type="state" id="c75944fb-cc94-4a78-8d91-dbeead45e9dd" />
...
<Answer type="state" id="9a0423f2-4aea-4361-99c5-c4b1009dee9d" />
...
<Solution id="e46e1f4f-3032-4c10-94c5-3bd0db8df748">
...
:::aufgabe
<Answer type="state" id="a23144ba-e117-4c89-890f-680aebf0c533" />
