---
page_id: 982a65b1-d87f-450c-b009-1b4a27f3a1e0
---
...
:::flex{flexBasis=300px alignItems=center .compactDeflist}
...
Hier der Vergleich für `inf.gbsl.website`:
<Video title='Suchen vs. URL verwenden' src={useBaseUrl('/img/docs/material/BYOD-Basics-2025/05-Web/search_vs_direct_url.mp4')} />

:::tip[Besser die URL eingeben]
Von vielen Webseiten wissen Sie die URL vermutlich auswendig: inf.gbsl.website, gbsl.ch, youtube.com, instagram.com, etc. Geben Sie diese URLs immer gleich direkt in die Adressleiste ein. Das spart Zeit und Klicks.
:::

:::warning[Auto-Vervollständigung]
Beim Tippen in der Adressleiste vervollständigt der Browser die Eingabe oft automatisch zu einer URL oder einer Suchanfrage. Dies kann praktisch sein, aber es kann einem auch in die Quere kommen. Bevor Sie [[Enter]] drücken, achten Sie deshalb immer darauf, was der Browser vervollständigt. Die meisten Browser zeigen auch mit einem Symbol an, ob Sie beispielsweise mit Google danach suchen wollen.

Wenn Sie mit dem Vorschlag nicht einverstanden sind, können Sie ihn in der Regel mit der [[Backspace]]oder [[Esc]] -Taste löschen und dann Ihre eigene Eingabe abschliessen.
:::
...
- `gbsl.ch` (die Domain-Endung ist hier `.ch`)
- `inf.gbsl.website` (die Domain-Endung ist hier `.website`)
...
<Video title='Bookmarks in Microsoft Edge' src={useBaseUrl('/img/docs/material/BYOD-Basics-2025/05-Web/bookmarks_edge.mp4')} />
<Video title='Bookmarks in Safari' src={useBaseUrl('/img/docs/material/BYOD-Basics-2025/05-Web/bookmarks_safari.mp4')} />
<Video title='Bookmarks in Google Chrome' src={useBaseUrl('/img/docs/material/BYOD-Basics-2025/05-Web/bookmarks_chrome.mp4')} />
<Video title='Bookmarks in Mozilla Firefox' src={useBaseUrl('/img/docs/material/BYOD-Basics-2025/05-Web/bookmarks_firefox.mp4')} />

:::aufgabe[Bookmark für inf.gbsl.website erstellen]
<TaskState id="d4ba3ffe-13af-468f-8601-630305c2ee1b" />
1. Öffnen Sie mit Ihrem Browser (in einem neuen Tab) Ihre Informatik-Klassen-Startseite (dort, wo Sie den Terminplan sehen).
...
<OsTabs>
    <TabItem value="win">
        ...
        3. **Installationsdatei herunterladen**: Klicken Sie auf den Download-Link, um die Installationsdatei herunterzuladen. Diese Datei hat in der Regel die Endung `.exe` oder `.msi`.
        ...
        5. **Installationsprogramm ausführen**: Es öffnet sich ein Installationsprogramm. Folgen Sie dessen Anweisungen, um das Programm zu installieren.
            :::info[Installationspfad]
            Bei der Installation werden Sie oft gefragt, wo das Programm installiert werden soll. Da die Installation Computer-Spezifisch ist, bringt es nichts (oder macht das Programm sogar langsamer), wenn Sie als Installationspfad einen OneDrive-Ordner wählen.
            
            **In der Regel ist der vorgeschlagene Standard-Installationspfad in Ordnung.**
            :::
        ...
        7. **Installation prüfen**: Suchen Sie in der globalen Suche (Startmenü) nach dem Programm und starten Sie es, um zu überprüfen, ob die Installation erfolgreich war.
    </TabItem>
    <TabItem value="mac">
        1. **Webseite des Herstellers aufrufen**: Öffnen Sie die Webseite des Herstellers des Programms, das Sie installieren möchten. Prüfen Sie, ob Sie wirklich auf der offiziellen Webseite sind.
