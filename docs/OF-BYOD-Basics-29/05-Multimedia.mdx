---
page_id: 1f06cd92-06a0-4869-b480-b98b5a397b59
---
...
5. Sie können Textdateien in einem Texteditor öffnen, bearbeiten (inkl. Suchen&Ersetzen) und speichern.
:::
...
<OsTabs>
  <TabItem value="win">
    ![Snipping Tool --width=450px](/img/byod-basics/win11/snipping-tool.png)

    1. Unter dem Startmenü nach `Snipping Tool` suchen.
    2. Es gibt vier Optionen um eine Bildschirmaufnahme zu erfassen:
      ![Snipping Optionen](img/snipping-options.png)
  </TabItem>
  <TabItem value="mac">
    ![--width=150px](/img/byod-basics/osx/apps_bildschirmfoto.png)
...
## Text Editor
Einfache Textdateien (z.B. mit der Endung `.txt` oder `.py` ) lassen sich mit dem eingebauten Text Editor öffnen und bearbeiten.
<OsTabs>
  <TabItem value="win11">
    ...
    ![--width=600px](/img/byod-basics/win11/oeffnen_mit_standard.png)

    Falls sich folgendes Fenster öffnet, wählen Sie hier __Editor__ aus und klicken Sie auf __Nur&nbsp;einmal__:

    ![--width=500px](/img/byod-basics/win11/oeffnen_mit_editor.png)
  </TabItem>
  <TabItem value="win10">
    Um eine Datei mit dem Windows __Editor__ zu öffnen, machen Sie einen Rechtsklick auf die Datei und klicken Sie __Öffnen mit__ → __Editor__
  ...
  <TabItem value="mac">
    ...
    ![--width=600px](/img/byod-basics/osx/open_with_textedit.png)
