---
page_id: 1e6adac4-70eb-4213-b63c-005823195632
---
...
<OsTabs>
  <TabItem value="win">
    ![ZIP Datei --width=150px](/img/byod-basics/win11/zip_file.jpg)
    <Video src={useBaseUrl('/img/byod-basics/win11/explorer-zip.mp4')} />
  </TabItem>
  <TabItem value="mac">
    ![ZIP Datei --width=150px](/img/byod-basics/osx/zip_file.jpg)
