---
page_id: 66245e8e-6b58-47a5-a9c4-6aae02e72dd8
---
...
![Explorer --width=100px](./images/win_explorer.svg)

Wenn wir ein neues Explorer-Fenster öffnen, sehen wir folgende Ansicht:

![Neues Explorer-Fenster](./images/win_explorer_new.png)
...
::::dd
:::warning[Dateien auf dem Desktop]
Dateien auf dem Desktop sind super schnell zugänglich, da sie bereits beim Start des Geräts direkt sichtbar sind. Erfahrungsgemäss wirkt der Desktop schnell überfüllt und unaufgeräumt - **vermeiden Sie es, dort zu viele Dateien abzulegen**.

![--width=300px](./images/win_bloated_desktop.png)
:::
::::
`Downloads`
...
<ChoiceAnswer multiple randomizeOptions correct={[1, 7]} keepExpanded="correct" id="decdd884-755e-42e3-bd03-349850465f7a">
    Wählen Sie alle Ordner aus, die oben (im Bild) in der Seitenleiste aufgelistet sind:
...
![Finder --width=100px](./images/macos_finder.svg)

Das Finder-Fenster ist wie folgt gegliedert:

![Finder-Fenster](./images/macos_finder_overview.png)
...
<ChoiceAnswer multiple randomizeOptions correct={[1, 2, 3, 4]} keepExpanded="correct" id="decdd884-755e-42e3-bd03-349850465f7a">
    Wählen Sie alle Ordner aus, die oben (im Bild) in der Seitenleiste aufgelistet sind:
...
:::warning
Die Pfadleiste ist im Finder standardmässig **ausgeblendet**. Sie können sie aber über das Menü «Darstellung» → «Pfadleiste einblenden» aktivieren.
:::
</TabItem>
</OsTabs>
...
<OsTabs>
    <TabItem value="win">
        ...
        :::cards{flexBasis=370px}
        ![Ordner `Übung Navigation Explorer`](./images/navigation-exercise/main_folder_win.png)
        ::br
        ![Unterordner `Backups`](./images/navigation-exercise/backups_folder_win.png)
        :::
        ...
        <Video title="Pfad des aktuellen Ordners kopieren" src={useBaseUrl('/img/byod-basics/win11/copy_folder_path.mp4')}/>

        <Video title="Pfad einer Datei oder eines Ordners im Anzeigebereich kopieren" src={useBaseUrl('/img/byod-basics/win11/copy_file_path.mp4')}/>
        :::
        ...
        **Löschen** Sie nun den Ordner `Übung Navigation Explorer`, um die Aufgabe abzuschliessen, und markieren Sie diese als erledigt.
        ...
        ![Pfad des Ordners `Übung Navigation Explorer`](./images/navigation-exercise/path_win.png)
    ...
    <TabItem value="mac">        
        ...
        :::cards
        ![Ordner `Übung Navigation Finder`](./images/navigation-exercise/main_folder_macos.png)
        ::br
        ![Unterordner `Backups`](./images/navigation-exercise/backups_folder_macos.png)
        :::
        ...
        <Video title="Pfad des aktuellen Ordners kopieren" src={useBaseUrl('/img/byod-basics/osx/copy_folder_path.mp4')}>
        1. [[:mdi[cursor-default-click] Rechtsklick]] auf den Ordner in der Pfadleiste
        2. `… als Pfadname kopieren`.
        </Video>
        
        <Video title="Pfad einer Datei oder eines Ordners im Anzeigebereich kopieren" src={useBaseUrl('/img/byod-basics/osx/copy_file_path.mp4')}>
...
<OsTabs>
    <TabItem value="win">
        ...
        <Video src={useBaseUrl('/img/byod-basics/win11/delete_restore.mp4')}/>
    </TabItem>
    <TabItem value="mac">
        Wenn wir eine Datei _löschen_, wird sie in der Regel nicht sofort endgültig entfernt, sondern landet im **Papierkorb**. Dort kann sie wiederhergestellt werden, solange der Papierkorb nicht geleert wurde.

        So können Sie eine Datei im Finder löschen (also in den Papierkorb verschieben) und anschliessend wiederherstellen
        <Video src={useBaseUrl('/img/byod-basics/osx/delete_restore.mp4')}/>
    </TabItem>
</OsTabs>
