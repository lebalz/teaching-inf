...
Damit wir diese Aspekte genauer anschauen können, simulieren wir einen einfachen Rechner. Der "Little Man Computer" [LMC von Peter Higginson](https://www.peterhigginson.co.uk/lmc/) eignet sich dazu sehr gut.
...
<Answer id="7592108e-e78e-4152-b658-665ba0ca8a1e" type="text" />
:::
