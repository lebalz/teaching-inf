...
import { mdiClipboardCheck, mdiClipboardText, mdiClipboardTextOff, mdiLoading } from '@mdi/js';
            ...
            <div className="container">
                ...
                >
                    <div className={clsx(styles.flex)}>
                        <div>Code ohne Kommentare Kopieren</div>
                        <Icon
                            path={ICONS[copyState]}
                            color={COLORS[copyState]}
                            size={1}
                            spin={copyState === 'processing'}
                        />
                    </div>
                </button>
            </div>
