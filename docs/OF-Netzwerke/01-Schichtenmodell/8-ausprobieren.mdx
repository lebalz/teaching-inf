...
## Ein erstes Netzwerk mit IP-Adressen


Grösse
: 4-5 Micro\:Bits + Laptops
Ziel
: 4 __Client__-Geräte, eine "Verteilzentrale" (__Router__) die miteinander kommunizieren können
Anforderungen
: Alle Geräte können miteinander kommunizieren
Geräte
: [Client](/network/client-L3)
: [Router](/network/router)

:::aufgabe
<Answer type="state" id="169ec96a-c4dc-4aa8-ad09-c5f5df4b8a44" />



Halten Sie mit einem Foto das Netzwerk fest halten Sie folgende Informationen stichwortartig fest:
- Welche Informationen sind nötig, damit die Clients miteinander kommunizieren können?
- Welche Aufgabe hat der Router in diesem Netzwerk?
- Was passiert, wenn ein Client eine Nachricht an einen anderen Client sendet?
- Wie weiss der Router, wohin er die Nachricht weiterleiten muss?

<Answer type="text" id="010955f0-4ce0-47a7-9af5-f47a1ce0c55a" />
:::
