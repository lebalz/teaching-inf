...
page_id: c0771e3e-b46f-4176-b2bc-87c7f0e6a9a7
---
...
<OsTabs>
  <TabItem value="win11">
    ...
    ![Snipping Optionen](./images/snipping-options.png)
...
<OsTabs>
  <TabItem value="win11">
    Unter Windows 11 gibt es **neu** die Möglichkeit, Bildschirmvideos mit dem Snipping Tool aufzunehmen.
...
<OsTabs>
  ...
  <TabItem value="win10">
    ...
    <Video 
      title="Zuschneiden/Drehen"
      src={useBaseUrl('/img/byod-basics/win/edit_picture2.mp4')}
    >
      1. Foto doppelklicken (öffnen in "Fotos")
...
| Kategroie                        | Keine Personendaten erfassen | Eine Antwort pro Person\*   | Benutzerkonto erforderlich |
| :------------------------------: | :--------------------------: | :-------------------------: | :-------------------------: |
| Auswertung nach Person           |             ❌              |             ❌              |             ✅             |
| Ausfüllbar nur mit GBSL-Account  |             ❌              |             ✅              |             ✅             |
| Antworten erfassen               |             ✅              |             ✅              |             ✅             |
