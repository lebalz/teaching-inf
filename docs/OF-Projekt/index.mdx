...
import WithCmsDefList from '@tdev-components/documents/CmsText/WithCmsDefList';
...
: **{/*28Gb ->*/}<CmsText id="f496edd3-29ef-4e97-81ef-9f56955516f0" showActions/>{/*28Gj ->*/}<CmsText id="ec4e41e1-a828-42e6-89a7-097be8cebdf9" showActions/>**
: :mdi[microsoft-onedrive]{.blue} **Abgabe**: auf OneDrive [hier hochladen](https://erzbe-my.sharepoint.com/:f:/g/personal/balthasar_hofer_gbsl_ch/IgB1_hEfotmVSKvt1C0AD3KGAQ_qqr2xRlicVScW0SMPeUI)
: :mdi[folder-zip-outline]{.orange} **Dateiname**: __klasse-vorname1-vorname2.zip__
: :mdi[file-tree-outline] **Ordnerinhalt**: Siehe [Kapitel "Abgabe"](#abgabe)
:::

export const labeler = (theorie, praxis) => {
    return (entries, store) => {
        const fachP = store.find(entries.fachbegriffep)?.firstMainDocument;
        if (fachP?.type === 'cms_text') {
            if (fachP.isEmpty) {
                return praxis
            }
        }
...
<WithCmsDefList 
    entries={{
        tagebuch: "b3109b36-05e2-48d1-ba05-aeae6c095666",
        vorgabenp: "9d78eb59-2516-458d-b764-28d3c54bf763",	
        vorgabenn: "e116ca5d-9484-4912-a94a-d39981025b9b",        
        abgabep: "f8b2cb33-1fb9-4de0-9293-00484e17012a",	
        abgaben: "1a610e30-2a36-4e43-884d-51e46e59b824",	
        hintergrundp: "c8b6afdf-830f-4e33-b309-cd7264663794",	
        hintergrundn: "4d4f3e82-0bb5-4edd-9a31-1b3d22946ff4",	
        korrektp: "47dec5f7-4877-4495-b12b-a8692e67e038",	
        korrektn: "b80e0e5b-e9dc-4642-8913-4d21200198f3",	
        tiefep: "01d1ae27-1336-4177-8c77-766d9b4a6471",	
        tiefen: "5f56046e-d7bd-497a-b67b-00329e12f163",	
        fachbegriffep: "c517835e-6de7-4e68-8d66-563d80db6306",	
        fachbegriffen: "0406a5ea-17aa-4ee8-a255-d9da61ac578a",	
        aufbaup: "e84c86e8-2247-427e-9406-3a498cceb3ee",	
        aufbaun: "dcb5b83d-0013-4299-a6bd-6ac3469ef884",	
        skriptp: "a8634a72-4a92-408a-9235-c8843511aa7d",	
        skriptn: "fb6910c8-b74e-49ad-9005-d5f4fc50edf9",	
        tonp: "1304039b-7d1b-4cfe-b80c-9890882575cb",	
        tonn: "1149a111-39b3-4c2b-b24c-74e528b82014",	
        sprachep: "38b456cf-d1eb-4808-b251-ff32cfa5fd86",	
        sprachen: "41a70ecd-422a-4f26-92ee-56629e029092",	
        abzuege: "9e60dd23-f424-4160-b81e-6f2b1e11a971",	
        notizen: "a95b68d4-d566-43e6-b242-bad0f905a98d",	
        total: "e6147e53-546b-49f9-b6bb-802c36ff9bde",	
        note: "4b7dd593-24ce-460a-9097-62e08b94d7b8",
    ...
    labels={{
        ...
        vorgabenp: "Vorgaben",
        abgabep: "Abgabe",
        hintergrundp: "Hintergrund",
        korrektp: "Korrekt",
        tiefep: labeler("Tiefe", "praktischer Teil"),
        fachbegriffep: "Fachbegriffe",
        aufbaup: "Aufbau",
        skriptp: "Skript",
        tonp: "Ton",
        sprachep: "Sprache",
...
Es wird ein **.zip-Ordner** mit dem Namen `klasse-vorname.zip` (bzw. für Gruppen `klasse-vorname1-vorname2.zip`) per obigem OneDrive-Link abgegeben.
