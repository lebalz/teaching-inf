...
const RGBA = () => {
    ...
    return (
        <div className={clsx('hero', 'shadow--lw', containerStyles.container, styles.image)}>
            <div
                className="container"
                style={{
            ...
            >
                ...
                <div className={clsx(styles.color, styles.alpha)}>
                    <span className={clsx(styles.label)}>Alpha</span>
                    <Slider
                        value={a}
                        onChange={(c) => {
                            if (typeof c === 'number') {
                        ...
                        dots={false}
                    />
                    <span className={clsx(styles.value)}>{a}</span>
                </div>
