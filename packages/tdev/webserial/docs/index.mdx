...
export const IMP = `import Webserial from '@tdev/webserial/component';`;
...
<CodeShowcase imports={[IMP, `import BinaryDecoder from '@tdev/webserial/decoders/BinaryDecoder/component';`]}>
    <Webserial 
        baudRate={115200}
        hideLogs
        resetTrigger='::READY::'
